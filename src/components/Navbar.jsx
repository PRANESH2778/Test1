        ...
        <div className="top-bar">
          <div className="container d-flex justify-content-between align-items-center">
            <div className="contact-info">
              <span><FaEnvelope /> <a href="mailto:admin@cagmc.com">abc@gmail.com</a></span>
              <span><FaPhone /> <a href="tel:+919785312345">+91-98765 43210</a></span>
            </div>
          ...
          <div className={`collapse navbar-collapse ${isCollapsed ? "" : "show"}`} id="navbarSupportedContent">
            {isMobile && (
              <div className="mobile-contact">
                <p><FaEnvelope /> <a href="mailto:admin@cagmc.com">abc@gmail.com</a></p>
                <p><FaPhone /> <a href="tel:+919785312345">+91-98765 43210</a></p>
              </div>
            )}
            ...
            <ul className="navbar-nav ml-auto">
              ...
              >
                ...
                <div className={`dropdown-menu ${solutionsDropdownOpen ? "show" : ""}`} aria-labelledby="navbarDropdown">
                  <Link className="dropdown-item" to="/startupstrategy" onClick={closeNavbar}>StartupStrategy</Link>
                  <Link className="dropdown-item" to="/captivecenter" onClick={closeNavbar}>CaptiveCenterCreation</Link>
                  <Link className="dropdown-item" to="/firstgen" onClick={closeNavbar}>FirstGenBusinessAdvisory</Link>
                  <Link className="dropdown-item" to="/nextgen" onClick={closeNavbar}>NextGenFamilyBusiness</Link>
                </div>
              </li>
